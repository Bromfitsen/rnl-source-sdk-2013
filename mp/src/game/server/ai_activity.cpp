...
#ifdef RNL_DLL
	ADD_ACTIVITY_TO_SR(ACT_PRONE);
	ADD_ACTIVITY_TO_SR(ACT_PRONEIDLE);
	ADD_ACTIVITY_TO_SR(ACT_PLAYER_SPRINT_FIRE);
	ADD_ACTIVITY_TO_SR(ACT_PLAYER_PRONE_FIRE);

	//------------------------------//
	//	Weapon Position				//
	//------------------------------//
	ADD_ACTIVITY_TO_SR(ACT_VM_HIP2SHOULDER);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDER2SIGHT);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHT2HIP);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIP2SIGHT);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHT2SHOULDER);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDER2HIP);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIP2SHOULDEROPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDER2SIGHTOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHT2HIPOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIP2SIGHTOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHT2SHOULDEROPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDER2HIPOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIP2SHOULDER_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDER2SIGHT_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHT2HIP_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIP2SIGHT_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHT2SHOULDER_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDER2HIP_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIP2SHOULDEROPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDER2SIGHTOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHT2HIPOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIP2SIGHTOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHT2SHOULDEROPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDER2HIPOPEN_DEPLOYED);
	//------------------------------//
	//	Idle ANimations				//
	//------------------------------//
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPIDLE);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPIDLEOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERIDLE);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERIDLEOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTIDLE);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTIDLEOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPIDLE_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPIDLEOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERIDLE_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERIDLEOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTIDLE_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTIDLEOPEN_DEPLOYED);
	//------------------------------//
	//	Attack Animations			//
	//------------------------------//
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPFIRE1);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPFIRE2);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPFIRE3);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPFIREOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERFIRE1);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERFIRE2);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERFIRE3);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERFIREOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTFIRE1);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTFIRE2);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTFIRE3);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTFIREOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPFIRE1_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPFIRE2_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPFIRE3_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPFIREOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERFIRE1_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERFIRE2_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERFIRE3_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERFIREOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTFIRE1_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTFIRE2_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTFIRE3_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTFIREOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SECSHOULDERFIRE1);
	//------------------------------//
	//	Reload Animations			//
	//------------------------------//
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDEROPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_EJECT);
	ADD_ACTIVITY_TO_SR(ACT_VM_EJECTSLOW);
	ADD_ACTIVITY_TO_SR(ACT_VM_RELOADMID);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDEROPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_EJECT_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_EJECTSLOW_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_RELOADMID_DEPLOYED);
	//------------------------------//
	//	Draw/Holster Animations		//
	//------------------------------//
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPDRAW);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPDRAWOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPHOLSTER);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPHOLSTEROPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERDRAW);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERDRAWOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERHOLSTER);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERHOLSTEROPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTDRAW);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTDRAWOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTHOLSTER);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTHOLSTEROPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPDRAW_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPDRAWOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPHOLSTER_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIPHOLSTEROPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERDRAW_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERDRAWOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERHOLSTER_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOULDERHOLSTEROPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTDRAW_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTDRAWOPEN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTHOLSTER_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SIGHTHOLSTEROPEN_DEPLOYED);
	//------------------------------//
	//	Bolt Animations				//
	//------------------------------//
	ADD_ACTIVITY_TO_SR(ACT_VM_OPENBOLT);
	ADD_ACTIVITY_TO_SR(ACT_VM_CLOSEBOLT);
	ADD_ACTIVITY_TO_SR(ACT_VM_CYCLEBOLT);
	ADD_ACTIVITY_TO_SR(ACT_VM_OPENBOLT_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_CLOSEBOLT_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_CYCLEBOLT_DEPLOYED);
	//------------------------------//
	//	Spec. Grenade Animations	//
	//------------------------------//
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_UP);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_DOWN);
	ADD_ACTIVITY_TO_SR(ACT_VM_THROWLOWER);
	ADD_ACTIVITY_TO_SR(ACT_VM_THROWSIDE);
	ADD_ACTIVITY_TO_SR(ACT_VM_PREP);		// pull pin or unscrew cap
	ADD_ACTIVITY_TO_SR(ACT_VM_STARTFUSE);	// release spoon or pull string
	ADD_ACTIVITY_TO_SR(ACT_VM_STARTFUSEDOWN);
	ADD_ACTIVITY_TO_SR(ACT_VM_STARTFUSESIDE);
	ADD_ACTIVITY_TO_SR(ACT_VM_PREP_IDLE);	// idle anim when fuse has started
	ADD_ACTIVITY_TO_SR(ACT_VM_FIREMODE_SIDE2UP);
	ADD_ACTIVITY_TO_SR(ACT_VM_FIREMODE_SIDE2DOWN);
	ADD_ACTIVITY_TO_SR(ACT_VM_FIREMODE_DOWN2SIDE);
	ADD_ACTIVITY_TO_SR(ACT_VM_FIREMODE_DOWN2UP);
	ADD_ACTIVITY_TO_SR(ACT_VM_FIREMODE_UP2SIDE);
	ADD_ACTIVITY_TO_SR(ACT_VM_FIREMODE_UP2DOWN);

	//------------------------------//
	//	Special Animations			//
	//------------------------------//
	ADD_ACTIVITY_TO_SR(ACT_VM_SPECIALON);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPECIALOFF);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPECIALONOPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPECIALOFFOPEN);

	ADD_ACTIVITY_TO_SR(ACT_VM_CHECKWATCH);
	ADD_ACTIVITY_TO_SR(ACT_VM_WATCHIDLE);
	ADD_ACTIVITY_TO_SR(ACT_VM_HIDEWATCH);

	ADD_ACTIVITY_TO_SR(ACT_VM_CHANGEBARREL);
	ADD_ACTIVITY_TO_SR(ACT_VM_CHANGEBARRELHOT);

	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_ENTER);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_LEAVE);

	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_ENTER_OPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_IDLE_OPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_LEAVE_OPEN);

	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_ENTER_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_IDLE_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_LEAVE_DEPLOYED);

	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_ENTER_DEPLOYED_OPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_IDLE_DEPLOYED_OPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRONE_LEAVE_DEPLOYED_OPEN);

	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_ENTER_OPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_IDLE_OPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_LEAVE_OPEN);

	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_ENTER_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_IDLE_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_LEAVE_DEPLOYED);

	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_ENTER_DEPLOYED_OPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_IDLE_DEPLOYED_OPEN);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_LEAVE_DEPLOYED_OPEN);
#endif
}
