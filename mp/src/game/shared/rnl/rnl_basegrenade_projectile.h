...
public:
	...
	// realistic gravity - nuke
	static inline float GetGrenadeGravity() { return 1.0f; }
	static inline const float GetGrenadeFriction() { return 0.2f; }
	// less bounciness - nuke
	static inline const float GetGrenadeElasticity() { return 0.25f; }

	static inline float GetRollGravity()		{ return 1.0f; }
	static inline float GetRollFriction()		{ return 0.5f; }
	static inline float GetRollElasticity()		{ return 0.5f; }
