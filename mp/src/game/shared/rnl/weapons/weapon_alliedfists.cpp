...
#include "weapon_rnlbasemelee.h"
	...
	#define CWeaponAlliedFists C_WeaponAlliedFists
...
class CWeaponAlliedFists : public CWeaponRnLBaseMelee
{
public:
	DECLARE_CLASS( CWeaponAlliedFists, CWeaponRnLBaseMelee );
...
BEGIN_NETWORK_TABLE( CWeaponAlliedFists, DT_WeaponAlliedFists )
END_NETWORK_TABLE()

#ifdef GAME_DLL
	BEGIN_DATADESC( CWeaponAlliedFists )
	END_DATADESC()
#elif defined(CLIENT_DLL)
	BEGIN_PREDICTION_DATA(CWeaponAlliedFists)
	END_PREDICTION_DATA()
#endif

acttable_t CWeaponAlliedFists::m_acttable[] = 
{
...
IMPLEMENT_ACTTABLE(CWeaponAlliedFists);

LINK_ENTITY_TO_CLASS( weapon_alliedfists, CWeaponAlliedFists );

PRECACHE_WEAPON_REGISTER( weapon_alliedfists );

CWeaponAlliedFists::CWeaponAlliedFists()
{

}

//=====================================================================================// 
// CWeaponAlliedFists::ItempostFrame()
// Purpose: Method called every frame. Check for buttons/keys pressed Checks reload 
// status and calls WeaponIdle()
//
//=====================================================================================//
void CWeaponAlliedFists::ItemPostFrame()
{
