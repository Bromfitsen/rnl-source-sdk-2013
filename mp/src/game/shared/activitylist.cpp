...
#ifdef RNL_DLL
	REGISTER_SHARED_ACTIVITY(ACT_PRONE);
	REGISTER_SHARED_ACTIVITY(ACT_PRONEIDLE);
	REGISTER_SHARED_ACTIVITY(ACT_PLAYER_SPRINT_FIRE);
	REGISTER_SHARED_ACTIVITY(ACT_PLAYER_PRONE_FIRE);

	//------------------------------//
	//	Weapon Position				//
	//------------------------------//
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIP2SHOULDER);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDER2SIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHT2HIP);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIP2SIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHT2SHOULDER);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDER2HIP);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIP2SHOULDEROPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDER2SIGHTOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHT2HIPOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIP2SIGHTOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHT2SHOULDEROPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDER2HIPOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIP2SHOULDER_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDER2SIGHT_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHT2HIP_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIP2SIGHT_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHT2SHOULDER_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDER2HIP_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIP2SHOULDEROPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDER2SIGHTOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHT2HIPOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIP2SIGHTOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHT2SHOULDEROPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDER2HIPOPEN_DEPLOYED);
	//------------------------------//
	//	Idle ANimations				//
	//------------------------------//
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPIDLE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPIDLEOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERIDLE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERIDLEOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTIDLE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTIDLEOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPIDLE_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPIDLEOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERIDLE_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERIDLEOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTIDLE_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTIDLEOPEN_DEPLOYED);
	//------------------------------//
	//	Attack Animations			//
	//------------------------------//
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPFIRE1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPFIRE2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPFIRE3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPFIREOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERFIRE1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERFIRE2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERFIRE3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERFIREOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTFIRE1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTFIRE2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTFIRE3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTFIREOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPFIRE1_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPFIRE2_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPFIRE3_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPFIREOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERFIRE1_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERFIRE2_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERFIRE3_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERFIREOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTFIRE1_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTFIRE2_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTFIRE3_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTFIREOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SECSHOULDERFIRE1);
	//------------------------------//
	//	Reload Animations			//
	//------------------------------//
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDEROPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_EJECT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_EJECTSLOW);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOADMID);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDEROPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_EJECT_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_EJECTSLOW_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOADMID_DEPLOYED);
	//------------------------------//
	//	Draw/Holster Animations		//
	//------------------------------//
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPDRAW);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPDRAWOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPHOLSTER);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPHOLSTEROPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERDRAW);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERDRAWOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERHOLSTER);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERHOLSTEROPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTDRAW);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTDRAWOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTHOLSTER);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTHOLSTEROPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPDRAW_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPDRAWOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPHOLSTER_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIPHOLSTEROPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERDRAW_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERDRAWOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERHOLSTER_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOULDERHOLSTEROPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTDRAW_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTDRAWOPEN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTHOLSTER_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SIGHTHOLSTEROPEN_DEPLOYED);
	//------------------------------//
	//	Bolt Animations				//
	//------------------------------//
	REGISTER_SHARED_ACTIVITY(ACT_VM_OPENBOLT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_CLOSEBOLT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_CYCLEBOLT);
	REGISTER_SHARED_ACTIVITY(ACT_VM_OPENBOLT_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_CLOSEBOLT_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_CYCLEBOLT_DEPLOYED);
	//------------------------------//
	//	Spec. Grenade Animations	//
	//------------------------------//
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_UP);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_DOWN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_THROWLOWER);
	REGISTER_SHARED_ACTIVITY(ACT_VM_THROWSIDE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PREP);		// pull pin or unscrew cap
	REGISTER_SHARED_ACTIVITY(ACT_VM_STARTFUSE);	// release spoon or pull string
	REGISTER_SHARED_ACTIVITY(ACT_VM_STARTFUSEDOWN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_STARTFUSESIDE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PREP_IDLE);	// idle anim when fuse has started
	REGISTER_SHARED_ACTIVITY(ACT_VM_FIREMODE_SIDE2UP);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FIREMODE_SIDE2DOWN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FIREMODE_DOWN2SIDE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FIREMODE_DOWN2UP);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FIREMODE_UP2SIDE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FIREMODE_UP2DOWN);

	//------------------------------//
	//	Special Animations			//
	//------------------------------//
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPECIALON);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPECIALOFF);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPECIALONOPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPECIALOFFOPEN);

	REGISTER_SHARED_ACTIVITY(ACT_VM_CHECKWATCH);
	REGISTER_SHARED_ACTIVITY(ACT_VM_WATCHIDLE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HIDEWATCH);

	REGISTER_SHARED_ACTIVITY(ACT_VM_CHANGEBARREL);
	REGISTER_SHARED_ACTIVITY(ACT_VM_CHANGEBARRELHOT);

	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_ENTER);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_IDLE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_LEAVE);

	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_ENTER_OPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_IDLE_OPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_LEAVE_OPEN);

	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_ENTER_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_IDLE_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_LEAVE_DEPLOYED);

	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_ENTER_DEPLOYED_OPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_IDLE_DEPLOYED_OPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRONE_LEAVE_DEPLOYED_OPEN);

	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_ENTER_OPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_IDLE_OPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_LEAVE_OPEN);

	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_ENTER_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_IDLE_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_LEAVE_DEPLOYED);

	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_ENTER_DEPLOYED_OPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_IDLE_DEPLOYED_OPEN);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_LEAVE_DEPLOYED_OPEN);
#endif
